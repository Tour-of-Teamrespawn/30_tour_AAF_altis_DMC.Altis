...
_missionTemplates = ["AA Hunt", "Arty Hunt", "Assassination", "Attack", "Bomb Defusal", "Clear AO", "Defend" ,"Destroy Convoy", "IED Defusal", "MIA", "Patrol", "Patrol From Base", "River Patrol", "Scud Hunt", "Weapons Cache"];
...
_sliderInfantry sliderSetRange [0, 12]; _sliderInfantry sliderSetspeed [1, 12]; _sliderInfantry sliderSetPosition 0;
