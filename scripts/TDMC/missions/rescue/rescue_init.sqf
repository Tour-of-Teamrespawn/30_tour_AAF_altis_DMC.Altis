...
}forEach (nearestObjects [[worldSize / 2, worldSize / 2, 0], ["Land_vn_o_prop_cong_cage_01"], worldSize]);
...
[[_position], {_this call TDMC_fnc_captive}] remoteExecCall ["spawn", TDMC_captiveUnit, false];
